 ...
 */
@NonNullByDefault
public class VWCarNetInstallationsJSON extends VWCarNetBaseThingJSON {

    private @Nullable Data data;

    VWCarNetInstallationsJSON() {
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        VWCarNetInstallationsJSON rhs = ((VWCarNetInstallationsJSON) other);
