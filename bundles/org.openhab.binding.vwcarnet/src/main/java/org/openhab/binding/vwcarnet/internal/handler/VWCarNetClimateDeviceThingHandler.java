...
/**
 * Handler for all Climate Device thing types that VWCarNet provides.
 *
 * @author Jan Gustafsson - Initial contribution
 *
 */
@NonNullByDefault
public class VWCarNetClimateDeviceThingHandler extends VWCarNetThingHandler {
    ...
    public VWCarNetClimateDeviceThingHandler(Thing thing) {
        super(thing);
    }
    ...
    public synchronized void update(@Nullable VWCarNetThingJSON thing) {
        ...
        if (getThing().getThingTypeUID().equals(THING_TYPE_SMOKEDETECTOR)
            ...
            VWCarNetClimatesJSON obj = (VWCarNetClimatesJSON) thing;
            if (obj != null) {
    ...
    private void updateClimateDeviceState(VWCarNetClimatesJSON climateJSON) {
