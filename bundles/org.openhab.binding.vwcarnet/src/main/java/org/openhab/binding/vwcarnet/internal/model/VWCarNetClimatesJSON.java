 ...
 */
@NonNullByDefault
public class VWCarNetClimatesJSON extends VWCarNetBaseThingJSON {
     ...
     * @param data
     */
    public VWCarNetClimatesJSON(@Nullable Data data) {
        super();
        this.data = data;
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!(other instanceof VWCarNetClimatesJSON)) {
            return false;
        }
        VWCarNetClimatesJSON rhs = ((VWCarNetClimatesJSON) other);
