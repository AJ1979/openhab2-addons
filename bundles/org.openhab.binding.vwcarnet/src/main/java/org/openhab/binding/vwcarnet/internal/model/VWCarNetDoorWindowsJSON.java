 ...
 */
@NonNullByDefault
public class VWCarNetDoorWindowsJSON extends VWCarNetBaseThingJSON {
     ...
     *
     */
    public VWCarNetDoorWindowsJSON() {
    }
     ...
     * @param data
     */
    public VWCarNetDoorWindowsJSON(@Nullable Data data) {
        super();
        this.data = data;
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!(other instanceof VWCarNetDoorWindowsJSON)) {
            return false;
        }
        VWCarNetDoorWindowsJSON rhs = ((VWCarNetDoorWindowsJSON) other);
