...
public class VWCarNetAlarmsJSON extends VWCarNetBaseThingJSON {
     ...
     * @param data
     */
    public VWCarNetAlarmsJSON(@Nullable Data data) {
        super();
        this.data = data;
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!(other instanceof VWCarNetAlarmsJSON)) {
            return false;
        }
        VWCarNetAlarmsJSON rhs = ((VWCarNetAlarmsJSON) other);
