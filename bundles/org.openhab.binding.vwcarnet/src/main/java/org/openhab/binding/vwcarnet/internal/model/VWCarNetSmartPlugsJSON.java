 ...
 */
@NonNullByDefault
public class VWCarNetSmartPlugsJSON extends VWCarNetBaseThingJSON {
     ...
     * @param data
     */
    public VWCarNetSmartPlugsJSON(@Nullable Data data) {
        super();
        this.data = data;
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!(other instanceof VWCarNetSmartPlugsJSON)) {
            return false;
        }
        VWCarNetSmartPlugsJSON rhs = ((VWCarNetSmartPlugsJSON) other);
