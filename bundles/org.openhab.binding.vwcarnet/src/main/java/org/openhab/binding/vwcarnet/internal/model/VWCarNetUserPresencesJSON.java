 ...
 */
@NonNullByDefault
public class VWCarNetUserPresencesJSON extends VWCarNetBaseThingJSON {
     ...
     *
     */
    public VWCarNetUserPresencesJSON() {
    }

    public VWCarNetUserPresencesJSON(Data data) {
        this.data = data;
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!(other instanceof VWCarNetUserPresencesJSON)) {
            return false;
        }
        VWCarNetUserPresencesJSON rhs = ((VWCarNetUserPresencesJSON) other);
