...
public class VWCarNetSmartLocksJSON extends VWCarNetBaseThingJSON {
     ...
     * @param data
     */
    public VWCarNetSmartLocksJSON(@Nullable Data data) {
        super();
        this.data = data;
    }
    ...
    public @Nullable VWCarNetSmartLockJSON getSmartLockJSON() {
        return smartLockJSON;
    }

    public void setSmartLockJSON(@Nullable VWCarNetSmartLockJSON smartLockJSON) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!(other instanceof VWCarNetSmartLocksJSON)) {
            return false;
        }
        VWCarNetSmartLocksJSON rhs = ((VWCarNetSmartLocksJSON) other);
