 ...
 */
@NonNullByDefault
public class VWCarNetBroadbandConnectionsJSON extends VWCarNetBaseThingJSON {
     ...
     *
     */
    public VWCarNetBroadbandConnectionsJSON() {
    }
     ...
     * @param data
     */
    public VWCarNetBroadbandConnectionsJSON(@Nullable Data data) {
        super();
        this.data = data;
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!(other instanceof VWCarNetBroadbandConnectionsJSON)) {
            return false;
        }
        VWCarNetBroadbandConnectionsJSON rhs = ((VWCarNetBroadbandConnectionsJSON) other);
